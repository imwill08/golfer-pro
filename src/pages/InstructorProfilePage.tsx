        ...
        {loading ? (
          ...
          <>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-4">
              <Link
                to="/instructors"
                className="inline-flex items-center gap-2.5 px-4 py-2 text-golf-blue dark:text-golf-blue-light bg-golf-blue/5 hover:bg-golf-blue/10 rounded-full transition-all duration-200 group font-medium shadow-sm hover:shadow"
              >
                <svg
              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-6 sm:py-8">
                <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                  ...
                  <div className="w-full md:w-1/4">
                    <div className="aspect-square overflow-hidden rounded-xl shadow-lg" style={{ maxWidth: '220px', margin: '0 auto' }}>
                      <img
